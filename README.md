...
The `pages/api` directory is mapped to `/api/`. Files in this directory are treatedas [API routes](https://nextjs.org/docs/pages/building-your-application/routing/api-routes) instead
...
- [Learn Next.js](https://nextjs.org/learn-pages-router) - an interactive Next.js t
