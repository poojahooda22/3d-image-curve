...
- [Learn Next.js](https://nextjs.org/learn-pages-route
...
Check out our [Next.js deployment documentation](https://nextjs.org/docs/pages/building-your-application/deploying) for more deta
